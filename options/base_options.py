...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='nir2rgb_gray', help='name of the experiment. It decides where to store samples and models')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='../dataset/train')
        parser.add_argument('--dataset_mode', type=str, default='ftest')
        ...
        # for generator
        parser.add_argument('--netG', type=str, default='spade', help='selects model to use for netG (pix2pixhd | spade | unet)')
        ...
        parser.add_argument('--use_unet', default=False, action='store_true',
                            help='use UNet in content encoder.')
